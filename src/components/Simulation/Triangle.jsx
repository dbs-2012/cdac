      ...
      <div className="left-sidebar-container">
        <div className="left-sidebar">
          ...
          <div className="left-sidebar-buttons">
            <div className="prev">
              <button className="side-buttons" onClick={displayPrev}>Prev</button>
            </div>
            <div className="next">
              <button className="side-buttons" onClick={displayNext}>Next</button>
            </div>
          </div>
        </div>
        <div className="display-all-steps-container">
          <div className="display-steps-button">
            <button onClick={setStyle} className="side-buttons">Click Here to See All Steps</button>
          </div>
          {
            btn &&
